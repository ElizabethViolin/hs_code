...
const SearchBar = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            <h1 class="mb-4 text-4xl py-5 font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl text-black">Harmonized System (HS)</h1>
            <p class="text-center mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48">Dive into the future of HS code searches and let our intelligent system do the work for you!                          </p>

            <div className="flex border-2 rounded-lg w-3/4">
                <input 
                    type="text" 
                    placeholder="Search..." 
                    className="w-full py-4 px-6 rounded-l-lg"
                    value={search}
